...
async def test_scorer_rejects_bad_fundamentals():
    ...
    agent = ScorerAgent()
    runner = Runner(
        app_name="research", agent=agent, session_service=session_service, auto_create_session=True
    )
    ...
    await session_service.create_session(
        app_name="research", user_id=u_id, session_id=s_id, state=initial_state
    )
        ...
        "stock_data": {
            "PERFECT": {
                ...
                "fundamentals": {
                    ...
                    "eps_growth_3yr_pct": 35.0,
                    "revenue_growth_pct": 25.0,
                    "roe_pct": 22.0,
                    "sector": "Quality Compounders",
                },
                "sentiment": {
