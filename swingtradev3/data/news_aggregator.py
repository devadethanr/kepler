...
News Aggregator
===============
Multi-source news aggregation: Tavily → DDGS → RSS feeds → Reddit.
...
class NewsAggregator:
    ...
    def _from_tavily(self, query: str) -> dict[str, Any] | None:
    ...
    def _from_ddgs(self, query: str) -> dict[str, Any] | None:
        try:
    ...
    def search_news(self, query: str) -> dict[str, Any]:
        """Search news with Tavily → DDGS fallback."""
    ...
    def sweep_market_news(self, query: str = "Indian stock market today Nifty 200 news") -> dict[str, Any]:
        """
